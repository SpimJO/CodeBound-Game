...
const Home = () => {
    ...
    const downloadLink = 'https://drive.google.com/file/d/11gM62wuv1wMUv9vIgBIQU0X3B5Y8fXyR/view?usp=sharing';
                                                            ...
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <div className="flex-1 min-w-0">
                                                                    ...
                                                                    <p className={`text-[13px] leading-snug break-words ${isDarkMode ? 'text-zinc-300' : 'text-zinc-600'}`}>
                                                                        ...
                                                                        <span className={isDarkMode ? 'text-zinc-400' : 'text-zinc-600'}> ΓÇó {player.tokensEarned.toLocaleString()} tokens</span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className={`flex items-center gap-2 text-xs ${isDarkMode ? 'text-zinc-500' : 'text-zinc-600'}`}>
                                                        ...
                                                        <span>Lvl {player.levelReached} ΓÇó {player.tokensEarned.toLocaleString()} tokens</span>
                                                    </div>
                                                </div>
