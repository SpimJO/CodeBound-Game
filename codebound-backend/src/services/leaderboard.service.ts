...
class LeaderboardService {
    ...
    private getSortOrder(sort: string): Prisma.UserProgressOrderByWithRelationInput[] {
        const sortOptions: Record<string, Prisma.UserProgressOrderByWithRelationInput[]> = {
            level: [{ highestLevel: 'desc' }, { totalTokens: 'desc' }, { lastPlayed: 'desc' }],
            tokens: [{ totalTokens: 'desc' }, { highestLevel: 'desc' }, { lastPlayed: 'desc' }],
            playtime: [{ lastPlayed: 'desc' }, { highestLevel: 'desc' }],
